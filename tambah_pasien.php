...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        $check = $conn->prepare(
            "SELECT idpasien FROM pasien WHERE norm = ?"
        );
        ...
        if ($result->num_rows > 0) {
            ...
            $error = "Nomor Rekam Medis $norm sudah terdaftar. Silakan gunakan nomor lain.";
            ...
            if ($stmt) {
                ...
                $error = "Gagal mempersiapkan query database: " . $conn->error;
            }
        }
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($notelpon ?? '') ?>"
                            required
                        >
